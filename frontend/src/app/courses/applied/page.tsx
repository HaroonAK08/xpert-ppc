...
export default function CourseAppliedPage() {
  return (
    <section className="relative overflow-hidden bg-background py-12 sm:py-16">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_top,_hsla(var(--accent),0.14),_transparent_55%)]" />
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mx-auto w-full max-w-md rounded-3xl border border-border bg-card p-5 text-center shadow-xl sm:p-8">
          ...
          <div className="flex flex-col gap-3">
            <Link
              href="/courses/login"
              className="inline-flex h-11 items-center justify-center rounded-full bg-gradient-to-r from-accent via-orange-500 to-red-500 px-6 text-sm font-extrabold text-white shadow-md shadow-orange-500/30 hover:opacity-95"
            >
              Go to sign in
            </Link>
            <Link
