export const coursesLanding = {
  ...
  marquee: [
    ...
    'Live feedback from the Xpert PPC team',
  ],
  hero: {
    eyebrow: 'Limited-time academy offer',
    title: 'Stop guessing. Start running ads that pay.',
    subtitle:
      'One academy. Three complete tracks — Google & Microsoft Ads, Social Media Marketing, and SEO — taught step by step by people who scale real accounts for clients.',
    primaryCta: 'Apply for all 3 tracks',
    secondaryCta: 'Sign in',
    trust: ['Agency-taught curriculum', 'Apply → get accepted → learn', 'WhatsApp support'],
  },
  stats: [
